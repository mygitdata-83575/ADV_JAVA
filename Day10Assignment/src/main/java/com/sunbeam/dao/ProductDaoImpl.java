...
public class ProductDaoImpl implements ProductDao{
	...
	public List<Product> getProductByPriceAndCategory(double strtPrice, double endPrice, Category1 category){
	...
	@Override
	public String applyDiscount(Category1 category,double discount) {
